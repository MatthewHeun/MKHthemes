...
* Gray background? Really? 
  ...
  Too much ink is spilt on this background.
* Dark gray background for the facet labels? 
  Again, too much ink used for non-data elements.
...
p + MKHthemes::xy_theme(x_axis_labels_spacing = -5, y_axis_labels_spacing = 20)
