...
# Contributing to `MKHthemes`

This document outlines how to propose a change to the `MKHthemes` package.
...
* New code should be written in a style that matches the rest of the code in `MKHthemes`. 
